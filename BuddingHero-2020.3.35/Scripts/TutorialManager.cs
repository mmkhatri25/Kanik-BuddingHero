...
public static class TutorialManager
{
	...
	private static bool UpdateAndCheckChristmasTreeEventUnlockedComplete()
	{
		...
		if (TutorialManager.christmasTreeEventUnlocked == TutorialManager.ChristmasTreeEventUnlocked.OPEN_POPUP)
		{
			...
			TutorialManager.SetArrow(TutorialManager.pt, (TutorialManager.uiManager.state != UiState.HUB) ?
				TutorialManager.uiManager.panelHub.christmasEventParent.transform : 
				TutorialManager.uiManager.panelHub.christmasEventParent.transform, false, true,
				(TutorialManager.uiManager.state != UiState.HUB) ? 0f : -0.1f, false, 0f);
			TutorialManager.pt.Move(0f, 64f, 620f, 0f, 400f);
		}
