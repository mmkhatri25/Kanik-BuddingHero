...
/*
	...
	*/
	...
	public class RewardData
	{
		...
		{
			return this.amountAeons > 0.0 || this.amountCredits > 0.0 || this.amountMythstones > 0.0 || 
				this.amountScraps > 0.0 || this.amountToken > 0.0 || this.amountCandies > 0.0 || 
				this.amountTrinketBoxes > 0 || (this.skinIds != null && this.skinIds.Count > 0);
		}
